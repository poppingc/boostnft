...
// File: contracts\token\VoteNft.sol

pragma solidity >=0.4.22 <0.9.0;
pragma experimental ABIEncoderV2;

contract VoteNft is ERC721, Auth {
    ...
    constructor(
        ...
        string memory _uri
    ) public ERC721("VoteNFT", _nftSymbol) {
        _setBaseURI(_uri);
    }
    ...
    function mintNft(address _to, uint256 _num) public onlyOperator {
    ...
    function queryUserNftInfo(address _user) public view returns (NftInfo memory) {
